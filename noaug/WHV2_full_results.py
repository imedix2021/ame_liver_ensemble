...
acc = accuracy_score(y_test2, Voting(X_test,y_test2,1,1))
print('Normal HardVoting2 acc:', acc)
weighted_acc =  accuracy_score(y_test2, Voting(X_test,y_test2,1.28837564,0.5))
print('WeightedHardVoting2 acc:', weighted_acc)
print(classification_report(y_test2, Voting(X_test,y_test2,1.28837564,0.5), digits=3, target_names=['BLTumor', 'LCyst', 'MLCancer', 'PLCancer']))
cf_matrix = confusion_matrix(y_test2, Voting(X_test,y_test2,1.28837564,0.5))
...
np.savetxt('correctLiver_WeightedHardVoting2.csv',true_classes,delimiter=',')

# testデータ n件の予測ラベル
#pred_classes = np.argmax(model.predict(X_test[0:n]), axis = 1)
pred_classes = Voting(X_test,y_test2,1.28837564,0.5)
#print('prediction:', pred_classes)
np.savetxt('predictionsLiver_WeightedHardVoting2.csv',pred_classes,delimiter=',')
...
plt.savefig('WeightedHardVoting2_Heatmap_20220423_final_rsf.png')
...
f = open('WeightedHardVoting2_Full_Final_Result_amed_liver.txt', 'w')
f.write('WeightedHardVoting2_\n')
f.write(classification_report(y_test2, Voting(X_test,y_test2,1.28837564,0.5), digits=3, target_names=['BLTumor', 'LCyst', 'MLCancer', 'PLCancer']) + '\n')
f.write(' \n')
