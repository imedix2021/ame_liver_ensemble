...
f = open(model_dir +"liver_noaugResNet50_20210727_rsf_batch32_size256.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'liver_noaugResNet50_20210727_rsf_batch32_size256.h5')
...
np.savetxt('correctLiver_512_noaugResNet50_all_20210727_rsf_batch32_size256.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_512_noaugResNet50_all_20210727_rsf_batch32_size256.csv',pred_classes,delimiter=',')


print('4x4_ResNet50_all_liver_noaug_20210727_rsf_batch32_size256Results')
...
plt.savefig('ResNet50_256_liver_108_Heatmap_20210727_rsf_batch32_size256.png')
