...
with strategy.scope():
    ...
    test_probs = np.load ('test_probs2.npy')
    ...
    np.savetxt('correct_Amed_Liver_LightGBM_Stack 2models Trial1 Optuna_seed.csv',true_classes,delimiter=',')
    ...
    np.savetxt('predictions_Amed_LightGBM_Stack 2models Trial1 Optuna_seed.csv',pred_classes,delimiter=',')

    print("4x4 EnsemgleStack_LightGBM_Stack 2models Trial1 Optuna seed_kfold_Report")
    ...
    plt.savefig('EnsembleStack_LightGBM_Stack2_Optuna__Heatmap_20220423_seed.png')
    ...
    plt.savefig('/home/USER/amed_liver/noaug/EnsembleStack_LightGBM_Stack2_Optuna__roc_curve1_seed.png')
    plt.gca().clear()
    ...
    plt.legend()
    #plt.show()
    plt.savefig('/home/USER/amed_liver/noaug/EnsembleStack_LightGBM_Stack2_Optuna__roc_curve2_macro_seed.png')
    plt.gca().clear()
    ...
    plt.legend()
    #plt.show()
    plt.savefig('/home/USER/amed_liver/noaug/EnsembleStack_LightGBM_Stack2_Optuna_roc_curve3_both_seed.png')
    plt.gca().clear()
    ...
    plt.legend()
    plt.savefig('/home/USER/amed_liver/noaug/EnsembleStack_LightGBM_Stack2_Optuna_roc_curve4_micro_seed.png')
    #plt.show()
