...
f = open(model_dir +"liver_256_noaugSeResNeXt50_all_20210729_rsf.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'liver_256_noaugSeResNeXt50_all_20210729_rsf.h5')
...
np.savetxt('correctLiver_512_noaugSeResNeXt50_108_20210729.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_512_noaugSeResNeXt50_108_20210729.csv',pred_classes,delimiter=',')

#Parameter
model.summary()

print('4x4_SeResNeXt50_108_liver_noaug_20210729_Results')
...
plt.savefig('SeResNeXt50_256_liver_108_Heatmap_20210729.png')
