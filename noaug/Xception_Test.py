...
f = open(model_dir +"Liver_256_noaugXception_20210726_rsf.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'Liver_256_noaugXception_20210726_rsf.h5')
...
np.savetxt('correctLiver_size256_noaugXception_108_20210726_rsf_batch32.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_size256_noaugXception_108_20210726_rsf_batch32.csv',pred_classes,delimiter=',')

#Parameter
model.summary()

print('4x4_Xception_108_liver_noaug_20210726_rsf_batch32_Results')
...
plt.savefig('Xception_size256_liver_108_Heatmap_20210726_rsf_batch32.png')
