...
f = open(model_dir +"Amed_Liver_249_20210726InceptionV3_rsf_batch32_size256.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'Amed_Liver_249_20210726InceptionV3_rsf_batch32_size256.h5')
...
np.savetxt('correctLiver_249_noaugInceptionV3_20210726_rsf_batch32_size256.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_249_noaugInceptionV3_20210726_rsf_batch32_size256.csv',pred_classes,delimiter=',')

#Parameters
model.summary()

print('4x4_InceptionV3_249_noaug_20210726_rsf_batch32_size256_Results')
...
plt.savefig('InceptionV3_249_Heatmap_20210726_rsf_batch32_size256.png')
