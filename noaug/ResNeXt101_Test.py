...
f = open(model_dir +"Liver_256_noaugResNeXt101_all_20220423_rsf_batch32.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'Liver_256_noaugResNeXt101_all_20220423_rsf_batch32.h5')
...
np.savetxt('correctLiver_size256_noaugResNeXt101_all_20220423_rsf_batch32.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_size256_noaugResNeXt101_all_20220423_rsf_batch32.csv',pred_classes,delimiter=',')

#Parameter
model.summary()

print('4x4_ResNeXt101_all_size256_liver_noaug_20220423_rsf_batch32_Results')
...
plt.savefig('ResNeXt101_all_sizxe256_liver_rsf_batch32_Heatmap_20220423.png')
