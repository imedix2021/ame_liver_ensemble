...
f = open(model_dir +"Amed_Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'Amed_Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy.h5')
...
np.savetxt('correctLiver_Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy.csv',pred_classes,delimiter=',')

#Parameters
model.summary()

print('4x4_Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy_Results')
...
plt.savefig('Liver_-20_256_20220312efficientnetB2_rsf_batch32_noisy_Heatmap.png')
...
#plt.title('ROC Curve')
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/efficientnetB2_rsf_batch32_liver_noaug_roc_curve1.png')
plt.gca().clear()
...
plt.legend()
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/efficientnetB2_rsf_batch32_liver_noaug_roc_curve2_macro.png')
plt.gca().clear()
...
plt.legend()
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/efficientnetB2_rsf_batch32_liver_noaug_roc_curve3_both.png')
plt.gca().clear()
...
plt.legend()
plt.savefig('/home/imedix/amed_liver/noaug/efficientnetB2_rsf_batch32_liver_noaug_roc_curve4_micro.png')
#plt.show()
...
plt.ylabel("True label", fontsize=13)
#ax.set_ylim(len(cf_matrix), 0)
plt.savefig('efficientnetB2_rsf_batch32_liver_Heatmap_20220423_final_rsf.png')
