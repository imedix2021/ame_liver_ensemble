...
def model_evaluate():
   #score = model.evaluate(X_test, y_test, verbose = 1)
    ...
    fileobj = open("efficientnetB6_-20_256_liver_20220312_rsf_batch32_noisy.txt", "w")
...
with strategy.scope():
    ...
    for fold, (train_index, val_index) in enumerate(kf.split(X_train,y_train)):
        ...
        model_checkpoint = ModelCheckpoint(
            weights_dir + "val_loss{val_loss:.3f}_efficientnetB6_-20_256_liver_20220312_rsf_batch32_noisy.hdf5",
            monitor = 'val_loss',
            verbose = 1,
            save_best_only = True,
...
model_save("efficientnetB6")
save_history(hist, os.path.join(result_dir, 'history_efficientnetB6_-20_256_liver_20220312_rsf_batch32_noisy.txt'))
learning_plot("efficientnetB6_-20_256_liver_20220312_rsf_batch32_noisy")
