...
f = open(model_dir +"liver_256_noaugSeResNeXt101_all_20220419_rsf_batch32.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'liver_256_noaugSeResNeXt101_all_20220419_rsf_batch32.h5')
...
np.savetxt('correctLiver_512_noaugSeResNeXt101_all_20220419_rsf_batch32.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_512_noaugSeResNeXt101_all_20220419_rsf_batch32.csv',pred_classes,delimiter=',')

#Parameter
model.summary()

print('4x4_SeResNeXt101_all_liver_noaug_20220419_rsf_batch32_Results')
...
plt.savefig('SeResNeXt101_256_liver_all_Heatmap_20220419_rsf_batch32.png')
