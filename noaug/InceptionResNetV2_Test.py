...
f = open(model_dir +"Amed_Liver_256_108_20210726InceptionResNetV2_rsf.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'Amed_Liver_256_108_20210726InceptionResNetV2_rsf.h5')
...
np.savetxt('correctLiver_256_noaugInceptionResNetV2_108_20210726_rsf_batch32.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_256_noaugInceptionResNetV2_108_20210726_rsf_batch32.csv',pred_classes,delimiter=',')

#Parameters
model.summary()

print('4x4_InceptionResNetV2_108_noaug_20210726_rsf_batch32_Results')
...
plt.savefig('InceptionResNetV2_108_rsf_batch32_Heatmap_20210726.png')
...
#plt.title('ROC Curve')
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/InceptionResNetV2_108_rsf_batch32_liver_noaug_roc_curve1.png')
plt.gca().clear()
...
plt.legend()
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/InceptionResNetV2_108_rsf_batch32_liver_noaug_roc_curve2_macro.png')
plt.gca().clear()
...
plt.legend()
#plt.show()
plt.savefig('/home/imedix/amed_liver/noaug/InceptionResNetV2_108_rsf_batch32_liver_noaug_roc_curve3_both.png')
plt.gca().clear()
...
plt.legend()
plt.savefig('/home/imedix/amed_liver/noaug/InceptionResNetV2_108_rsf_batch32_liver_noaug_roc_curve4_micro.png')
#plt.show()
...
plt.ylabel("True label", fontsize=13)
#ax.set_ylim(len(cf_matrix), 0)
plt.savefig('InceptionResNetV2_108_rsf_batch32_liver_Heatmap_20220423_final_rsf.png')
...
def std(tp, n, alpha=0.05):
    ...
    variance_of_sum = p_hat * (1-p_hat) / n
    std = variance_of_sum ** 0.5
    return p_hat - std, p_hat + std,  std
