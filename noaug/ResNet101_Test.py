...
f = open(model_dir +"liver_size256_noaugResNet101_26_rsf_batch32_20220423.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'liver_size256_noaugResNet101_26_rsf_batch32_20220423.h5')
...
np.savetxt('correctLiver_noaugResNet101_26_20220423_rsf_batch32_size256.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_noaugResNet101_26_20220423_rsf_batch32_size256.csv',pred_classes,delimiter=',')

#パラメータ表示
model.summary()

print('4x4_ResNet101_26_liver_noaug_20220423_rsf_batch32_size256_Results')
...
plt.savefig('ResNet101_26_liver_Heatmap_20220423_rsf_batch32_size256.png')
