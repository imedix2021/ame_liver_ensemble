...
f = open(model_dir +"liver_256_noaugResNeXt50_all_20210728_rsf.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)

#model = model_from_json(open('chest_finetunig2.json').read())
model.load_weights(weights_dir + 'liver_256_noaugResNeXt50_all_20210728_rsf.h5')
...
np.savetxt('correctLiver_512_noaugResNeXt50_all_20210728_rsf_batch32.csv',true_classes,delimiter=',')
...
np.savetxt('predictionsLiver_512_noaugResNeXt50_all_20210728rsf_batch32.csv',pred_classes,delimiter=',')

#Parameter
model.summary()

print('4x4_ResNeXt50_all_liver_noaug_20210728_rsf_batch32_Results')
...
plt.savefig('ResNeXt50_256_liver_all_Heatmap_20210728_rsf_batch32.png')
